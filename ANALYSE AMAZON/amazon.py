...
if 'df_cleaned' not in locals():
    print("Création d'un jeu de données factice pour la démonstration...")
    ...
    print("Jeu de données factice créé.")
    print(f"Colonnes disponibles : {df_cleaned.columns.tolist()}")


# --- 1. MATRICE DE CORRÉLATION ---
print("\n" + "="*50)
print("1. MATRICE DE CORRÉLATION")
print("="*50)
...
# --- 2. GRAPHIQUE DE RÉGRESSION LINÉAIRE ---
print("\n" + "="*50)
print("2. RÉGRESSION LINÉAIRE")
print("="*50)

try:
    feature_col = numeric_df.columns[0]
    target_col = numeric_df.columns[1]
    print(f"Utilisation de '{feature_col}' pour prédire '{target_col}'.")
    ...
    print("ERREUR : Pas assez de colonnes numériques.")
...
# Générer des données de classification binaire
...
print(f"Données créées : {len(df)} échantillons")
print(f"Distribution des classes :")
print(f"  - Classe 0 : {(y == 0).sum()} échantillons")
print(f"  - Classe 1 : {(y == 1).sum()} échantillons")
...
# Grille pour les zones de décision
...
print("="*50)
print(f"  Équation de la droite de décision :")
